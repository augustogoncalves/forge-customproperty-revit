...
namespace forgeSample.Controllers
{
    public class DesignAutomation4Revit
    {
        ...
        private const string ENGINE_NAME = "Autodesk.Revit+2020";
        ...
        protected DesignAutomation4Revit()
        {
    ...
    public class CompoundStructLayer : DesignAutomation4Revit
    {
        public CompoundStructLayer()
        {
            AppName = "CompoundStructLayer";
            AppBundleName = "CompoundStructLayer.zip";
            ActivityName = "CompoundStructLayerActivity";
            ResultName = "result.json";
        }

        public async Task StartExtract(Credentials credentials, string projectId, string versionId, string connectionId, string contentRootPath)
        {
